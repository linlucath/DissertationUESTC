...
%	\uestccover[<学院名称排版风格>]{<论文题目>}{<学科专业>}{<学号>}{<作者姓名>}{<指导教师>}{<教师职称>}{<学院>} % 单学位学士、研究生通用
	...
	经部分同学反馈，此模板在TeXLive2021上会出现无法按预期渲染封面下划线的情况，\textbf{所以请所有本地用户将自己的TeXLive环境更新到\href{https://mirror.bjtu.edu.cn/CTAN/systems/texlive/Images/}{\color{DarkRed}TeXLive2024及以上}}。
